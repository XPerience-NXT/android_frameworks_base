...
public class PlatLogoActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        letter.setText(mIsCM ? "xpe" : "K");

        String cmVersion = SystemProperties.get("ro.xpe.version");
        if (cmVersion != null) {
            //cmVersion = cmVersion.replaceAll("([0-9\\.]+?)-.*", "$1");
            String[] parts = cmVersion.split("-");
            cmVersion = parts[0];
        }
        ...
        tv.setText(mIsCM ? "XPerience " + cmVersion : "ANDROID " + Build.VERSION.RELEASE);
